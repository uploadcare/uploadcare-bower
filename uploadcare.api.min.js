...
c.push(new a[e](l,r,o).promise());return c},a={object:i.ObjectFile,input:i.InputFile,url:i.UrlFile,uploaded:i.UploadedFile,ready:i.ReadyFile}})}.call(this),function(){var t,i;t=e.expose,t("globals",e.settings.common),t("start",e.settings.common),t("fileFrom"),t("filesFrom"),t("FileGroup"),t("loadFileGroup"),t("locales",function(){var t;t=[];for(i in e.locale.translations)t.push(i);return t}())}.call(this)}({},"//ucarecdn.com/widget/2.8.1/uploadcare/");